...
const Contact = () => {
  return (
    ...
    <div class="lg:flex">
        <div class="xl:w-2/5 lg:w-2/5 bg-green-800 py-16 xl:rounded-bl rounded-tl rounded-tr xl:rounded-tr-none">
        ...
        <div class="xl:w-3/5 lg:w-3/5 bg-gray-200 dark:bg-gray-600 h-full pt-5 pb-5 xl:pr-5 xl:pl-0 rounded-tr rounded-br">
            <form id="contact" class="bg-white dark:bg-gray-800 py-4 px-8 rounded-tr rounded-br">
                ...
                <div class="w-full mt-6">
                    ...
                    <button type="submit" class="focus:outline-none bg-green-600 transition duration-150 ease-in-out hover:bg-indigo-600 rounded text-white px-8 py-3 text-sm leading-6 focus:border-4 focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700">Submit</button>
                </div>
            </form>
        </div>
    </div>
