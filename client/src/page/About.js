...
const About = () => {
  return (
    ...
    <div class="flex lg:flex-row flex-col lg:gap-8 sm:gap-10 gap-12">
        ...
        <div class="w-full lg:w-6/12">
            <img class="lg:block hidden w-full" src="https://images.unsplash.com/photo-1549608276-5786777e6587?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8OXx8YmlyZHN8ZW58MHx8MHx8&auto=format&fit=crop&w=500&q=60" alt="people discussing on board" />
